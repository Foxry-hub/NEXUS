                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="text-center">
                            <p class="text-gray-300">
                                Belum punya akun?
                                <a href="{{ route('register') }}" class="font-medium text-indigo-400 hover:text-indigo-300 transition-colors duration-300">
                                    Daftar sekarang
                                </a>
                            </p>
                        </div>
                ...
                <div class="mt-8">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-transparent text-gray-300">Atau masuk dengan</span>
                        </div>
                    </div>
