            ...
            <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mb-8">
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                        <div class="text-2xl font-bold text-white mb-2">5</div>
                        <div class="text-sm text-gray-300">Karya Tersimpan</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                        <div class="text-2xl font-bold text-white mb-2">12</div>
                        <div class="text-sm text-gray-300">Karya Disukai</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                        <div class="text-2xl font-bold text-white mb-2">3</div>
