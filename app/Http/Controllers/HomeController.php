    ...
    public function index()
    {
        ...
        $artworks = [
            ...
            [
                ...
                'artist' => 'Chris Taylor',
                'artist_avatar' => 'https://ui-avatars.com/api/?name=Chris+Taylor&background=6366F1&color=fff',
            ],
            [
                'id' => 8,
                ...
                'artist_avatar' => 'https://ui-avatars.com/api/?name=Alex+Martinez&background=6366F1&color=fff',
            ],
            [
                'id' => 9,
                'image' => 'https://picsum.photos/400/650?random=9',
                'title' => 'Concept Art',
                'artist' => 'Lisa Anderson',
                'artist_avatar' => 'https://ui-avatars.com/api/?name=Lisa+Anderson&background=6366F1&color=fff',
            ],
            [
                'id' => 10,
                ...
                'title' => '3D Render',
                'artist' => 'Tom Harris',
                'artist_avatar' => 'https://ui-avatars.com/api/?name=Tom+Harris&background=6366F1&color=fff',
            ],
        ];
